...
import { Building, DollarSign, Truck, Mail, Video, BookOpen } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="transform transition-transform hover:scale-105">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardTitle className="mt-4 text-xl">Smart Waste Collection</CardTitle>
              </CardHeader>
            ...
            <Card className="transform transition-transform hover:scale-105">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardTitle className="mt-4 text-xl">Reward System</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
            ...
            <Card className="transform transition-transform hover:scale-105">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardTitle className="mt-4 text-xl">Corporate Solutions</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
      ...
      <section id="video" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">See BINKS in Action</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Watch how our smart dustbin technology works and transforms waste management.
            </p>
          </div>
          
          <div className="aspect-w-16 aspect-h-9 bg-gray-200 rounded-xl overflow-hidden shadow-lg mx-auto max-w-4xl">
      ...
      <section id="tokenomics" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tokenomics</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-6">How You Earn Tokens</h3>
            ...
            <div className="bg-blue-50 p-8 rounded-xl shadow-md">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-700">Ecosystem Development</span>
      ...
      {/* Franchise Section */}
      <section id="franchise" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Franchise Opportunities</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-10">
                <h3 className="text-2xl font-bold text-gray-800 mb-6">Why Franchise With BINKS?</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="flex-shrink-0 text-green-500">✓</div>
                    <p className="ml-3 text-gray-600">Low initial investment with high returns</p>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 text-green-500">✓</div>
                    <p className="ml-3 text-gray-600">Comprehensive training and ongoing support</p>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 text-green-500">✓</div>
                    <p className="ml-3 text-gray-600">Proven business model with recurring revenue</p>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 text-green-500">✓</div>
                    <p className="ml-3 text-gray-600">Exclusive territory rights</p>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 text-green-500">✓</div>
                    <p className="ml-3 text-gray-600">Be part of an environmentally conscious business</p>
                  </li>
                </ul>
              ...
              <div className="bg-blue-600 p-10 text-white flex items-center">
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-100 p-6 rounded-lg text-center">
                ...
                <div className="text-gray-600">Smart Dustbins Deployed</div>
              </div>
              <div className="bg-gray-100 p-6 rounded-lg text-center">
      ...
      <section id="contact" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <div className="bg-blue-600 p-8 rounded-xl text-white mb-8">
              ...
              <div className="bg-gray-100 p-8 rounded-xl">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 transition">
                  ...
                  <a href="#" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-full hover:from-purple-600 hover:to-pink-600 transition">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#franchise" className="text-gray-400 hover:text-white transition">Franchise</a></li>
